...
def run():
    ...
    if not admin_user:
        admin_user = User(
            ...
            password_hash=get_password_hash("demo_pass_admin"),
            first_name="Admin",
            last_name="User",
    ...
    roles_to_seed = [
        (administrator_role, "administrator@transitops.com", "Admin", "demo_pass_adminpass"),
        (dispatcher_role, "dispatcher@transitops.com", "Dispatcher", "demo_pass_dispatch"),
        (maintenance_manager_role, "maintenance@transitops.com", "Maintenance", "demo_pass_maint"),
        (technician_role, "technician@transitops.com", "Technician", "demo_pass_tech"),
        (safety_officer_role, "safety@transitops.com", "Safety", "demo_pass_safety"),
        (hr_role, "hr@transitops.com", "HR", "demo_pass_hr"),
        (fleet_manager_role, "fleet@transitops.com", "Fleet", "demo_pass_fleet"),
        (driver_role, "driver@transitops.com", "Demo Driver", "demo_pass_driver"),
        (financial_analyst_role, "finance@transitops.com", "Finance", "demo_pass_finance"),
        (sysadmin_role, "sysadmin@transitops.com", "System Admin", "demo_pass_sysadmin"),
        (support_role, "support@transitops.com", "Support Agent", "demo_pass_support"),
        (procurement_role, "procurement@transitops.com", "Procurement", "demo_pass_procure"),
    ]
