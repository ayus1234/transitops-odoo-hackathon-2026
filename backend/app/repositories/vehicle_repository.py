...
Extended with VIN lookup for Vehicle 360.
"""
...
class VehicleRepository:
    ...
    def exists_by_vin(self, vin: str, exclude_id: Optional[UUID] = None) -> bool:
        """Check if vehicle exists by VIN / chassis number."""
        query = self.db.query(Vehicle).filter(Vehicle.vin == vin)
