  ...
  return (
    <div className="col-span-12 lg:col-span-4 space-y-lg">
      ...
      <section 
        ...
        className="bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm h-64 relative group cursor-pointer"
      >
        <div 
          className="w-full h-full bg-cover bg-center group-hover:scale-105 transition-transform duration-700" 
          style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDRNdYagD6fmrGN9BnsYvhNtNV7DXq2Vm6z2RDh6dYUv5m_v1gSKNItjXSRJOL9rJ5lzTtEUaPqFrY-uScJoZLGS2sGj9TZ91sZHgwWQHDrqQPIOkL2b8lP1g2ZF7qYe00OEFk0q19imu50dax1jcO7BL-yhd9udrK1oVK4cJcu6_roqe-WX97CkDhgWHs0Z9eXFW_MYdDB8Z11rvFlidCZsU_5ZgozHYL_C1dUJIaWmx1-Lj7U2UB0')" }}
        ></div>
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
        <div className="absolute bottom-md left-md right-md flex justify-between items-end">
          <div className="text-white">
            <h3 className="font-title-sm">Live Fleet Map</h3>
            <p className="text-[12px] opacity-80">View full fleet tracking</p>
          </div>
          <span className="material-symbols-outlined text-white bg-primary p-2 rounded-full shadow-lg">open_in_full</span>
        </div>
      </section>
